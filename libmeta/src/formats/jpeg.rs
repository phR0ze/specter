...
mod tests {
    ...
    fn test_parse_segment_data_not_enough_data() {
        let err = parse_segment_data(&JPEG_DATA_1[6..19], 14).unwrap_err();
        assert_eq!(err.to_string(), JpegError::not_enough_data().to_string());
        assert_eq!(
            err.source_to_string(),
            "nom::Parsing requires 1 bytes/chars"
    ...
    fn test_parse_segment_data_valid() {
        let (remain, data) = parse_segment_data(&JPEG_DATA_1[6..20], 14).unwrap();
        assert_eq!(remain, &[]);
        assert_eq!(data, &JPEG_DATA_1[6..20]);
    }
    ...
    fn test_parse_segment_length_success() {
        let (remain, length) = parse_segment_length(&JPEG_DATA_1[4..6]).unwrap();
        assert_eq!(remain, &[]);
        assert_eq!(length, 14);
    }
    ...
    fn test_parse_segment_marker_success() {
        let (remain, marker) = parse_segment_marker(&JPEG_DATA_1[2..4]).unwrap();
        assert_eq!(remain, &[]);
    ...
    const JPEG_DATA_1: [u8; 1260] = [
        ...
        0x03, 0x5e, // Exif size 862
        0x45, 0x78, 0x69, 0x66, 0x00, 0x00, // Exif signature
        0x4d, 0x4d, // TIFF byte alignment
        0x00, 0x2a, // IFD 0 marker
        0x00, 0x00, 0x00, 0x08, // IFD 0 start offset
        0x00, 0x06, // IFD entry count
        //
        // IFD entry headers
        //
        // IFD entry 0 header
        ...
        0x00, 0x00, 0x00, 0x56, // data value or offset to where the data is
        //
        0x01, 0x1a, 0x00, 0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x62, // IFD entry 1
        0x01, 0x1b, 0x00, 0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x6a, // IFD entry 2
        0x01, 0x28, 0x00, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, // IFD entry 3
        0x01, 0x32, 0x00, 0x02, 0x00, 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x72, // IFD entry 4
        0x87, 0x69, 0x00, 0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x86, // IFD entry 5
        //
        ,
        ...
        0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32,
        0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0x32, 0xff, 0xc0, 0x00,
        0x11, 0x08, 0x00, 0x03, 0x00, 0x07, 0x03, 0x01, 0x22, 0x00, 0x02, 0x11, 0x01, 0x03, 0x11,
        ...
        ,
